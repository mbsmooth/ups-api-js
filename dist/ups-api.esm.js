...
export { ACCESS_POINT_SEARCH, API, AUTH_FORM_DOC_TYPE, CERTIFICATE_ORIGIN_DOC_TYPE, CLOSEST_POINT_SEARCH, CUSTOMER_BOX_PACKAGING_TYPE, DECLARATION_DOC_TYPE, DUTIES_CHARGE_TYPE, EXPORT_ACCOMPANYING_DOC_TYPE, EXPORT_LICENSE_DOC_TYPE, EXPRESS_BOX_PACKAGING_TYPE, EXPRESS_SERVICE_CODE, FREIGHT_SHIPMENT_TYPE, IMPORT_PERMIT_DOC_TYPE, INTERNATIONAL_FORM_TYPE, INVOICE_DOC_TYPE, KGS_TYPE, LBS_TYPE, LETTER_INSTRUCTION_DOC_TYPE, LocatorAPI, NOTIFY_ACCESS_POINT_DELIVERY, NOTIFY_DELIVERY, NOTIFY_EXCEPTION, NOTIFY_IN_TRANSIT, NOTIFY_SHIP, ONE_TIME_NAFTA_DOC_TYPE, OTHER_DOC_TYPE, PACKING_LIST_DOC_TYPE, PAK_BOX_PACKAGING_TYPE, POWER_ATTORNEY_DOC_TYPE, PRODUCTION_CODE, PURCHASE_ORDER, PaperlessAPI, PickupAPI, REASON_FOR_EXPORT, RETURN_PRL, SAVER_SERVICE_CODE, SED_DOC_TYPE, SHIPMENT_HOLD_ACCESS_POINT, SMALL_PACKAGE_SHIPMENT_TYPE, STANDARD_SERVICE_CODE, STATUS_DELIVERED, STATUS_EXCEPTION, STATUS_IN_TRANSIT, STATUS_OUT_FOR_DELIVERY, STATUS_PICKUP, STATUS_RETURNED, ShipmentAPI, TRANSPORTATION_CHARGE_TYPE, TrackingAPI };
//# sourceMappingURL=ups-api.esm.js.map
